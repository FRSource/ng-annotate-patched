...
(function(){
    ...
    ClassTest6_annotated_let.$inject = ["$log"];
    ClassTest6_annotated_var.$inject = ["$log"];
    ...
    ClassTest6_annotated_expression_let.$inject = ["$log"];
    ClassTest6_annotated_expression_var.$inject = ["$log"];
    let ClassTest6_annotated_constructor_let = ClassTest6_annotated_constructor_var = class ClassTest6_annotated_constructor {
        /** @ngInject */
        constructor($log) {}
    };
    ClassTest6_annotated_constructor_let.$inject = ["$log"];
    ClassTest6_annotated_constructor_var.$inject = ["$log"];
    let ClassTest6_prologue_directive_let = ClassTest6_prologue_directive_var = class ClassTest6_prologue_directive {
        constructor($log) {
            "ngInject";
        }
    };
    ClassTest6_prologue_directive_let.$inject = ["$log"];
    ClassTest6_prologue_directive_var.$inject = ["$log"];
    ...
    ClassTest7_annotated_let.$inject = ["$log"];
    ClassTest7_annotated_var.$inject = ["$log"];
    ClassTest7_annotated_var_2.$inject = ["$log"];
    ...
    ClassTest7_annotated_expression_let.$inject = ["$log"];
    ClassTest7_annotated_expression_var.$inject = ["$log"];
    ClassTest7_annotated_expression_var_2.$inject = ["$log"];
    ...
    ClassTest7_annotated_constructor_let.$inject = ["$log"];
    ClassTest7_annotated_constructor_var.$inject = ["$log"];
    ClassTest7_annotated_constructor_var_2.$inject = ["$log"];
    ...
    ClassTest7_prologue_directive_let.$inject = ["$log"];
    ClassTest7_prologue_directive_var.$inject = ["$log"];
    ClassTest7_prologue_directive_var_2.$inject = ["$log"];
})();
